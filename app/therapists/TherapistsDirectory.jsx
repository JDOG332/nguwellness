...
const THERAPISTS = [
  ...
  { slug:"natalie-woodson", name:"Natalie Woodson", credentials:"LISW", title:"Licensed Independent Social Worker", photo:"/images/therapists/Natalie_Woodson.jpeg", color:"#2A3A5A", status:"accepting", yrs:5, specialties:["Anxiety","Depression","Trauma & PTSD","EMDR"], formats:["in-person","telehealth"], locations:["dayton"], days:["monday","tuesday","wednesday","thursday"], faith:false, ages:"Preteens · Teens · Adults · Elders 65+", couples:false, quote:"You're not broken. You're overwhelmed. There's a difference.", tags:["anxiety","depression","trauma","ptsd","emdr","stress","grief","relationship","substance","addiction","domestic violence","anger","disabilities","holistic","monday","tuesday","wednesday","thursday","inperson","telehealth","dayton","ohio","preteens","teens","adults","elders","family"] },
