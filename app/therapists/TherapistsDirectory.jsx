...
const dirStyles = `
  ...
  @media (max-width: 42.36rem) {
    .dir-grid { grid-template-columns: 1fr 1fr; gap: var(--s-sm); }
        ...
        {results.map(t => (
          ...
          >
              ...
              {t.photo ? (
                ...
                <div className="th-avatar">
                  <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
                    <circle cx="28" cy="22" r="12" fill="var(--divider)"/>
                    <path d="M6 50c0-12.15 9.85-22 22-22s22 9.85 22 22" fill="var(--divider)"/>
                  </svg>
                </div>
              )}
            ...
            <div className="th-specs">
              {t.specialties.slice(0,3).map(s => <span key={s} className="th-spec">{s}</span>)}
            </div>
