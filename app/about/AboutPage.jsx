          ...
          <div className="founders-row">
            ...
            <div className="founder-card">
              ...
              <div className="founder-info">
                ...
                <div className="bio-details">
                  <div className="bio-detail"><span className="bio-detail-label">Education</span><span className="bio-detail-value">BA, Miami University · MA, University of Dayton</span></div>
